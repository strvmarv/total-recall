  ...
  return (
    <div className="tr-mem-filters">
      ...
      <select aria-label="Tier filter" value={value.tier} onChange={(e) => onChange({ ...value, tier: e.target.value })}>
        <option value="">All tiers</option><option value="pinned">Pinned</option><option value="hot">Hot</option><option value="warm">Warm</option><option value="cold">Cold</option>
      </select>
